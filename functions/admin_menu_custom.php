...
if (!function_exists('remove_menus')) :
  function remove_menus() {
    ...
    //remove_menu_page( 'edit.php' );                 //Removing Blog Section
  }
...
if (!function_exists('hide_editor')) :
  function hide_editor() {
    ...
    if(
      ...
      $template_file == 'menus.php'           ||
      $template_file == 'about.php'           ||
      $template_file == 'private-dining.php'  ||
      $template_file == 'gallery.php'         ||
      $template_file == 'gallery-child.php'   ||
      $template_file == 'find-us.php'         ||
      $template_file == 'book-a-table.php'    ||
...
// Contact Form 7 -- Stopping the loading of the JavaScript and CSS stylesheet
